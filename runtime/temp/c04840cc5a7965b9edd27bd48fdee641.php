<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"D:\www\alasika\public\theme\admin\dictionary\index.html";i:1502880105;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    <form role="form" action="<?php echo url('index'); ?>" class="form-inline panel-body hidden-xs">
        <div class="form-group">
            <label for="ex1" class="sr-only">搜索编码值</label>
            <input type="text" placeholder="搜索编码值" id="ex1" class="form-control" name="di_encoding" value="<?php echo input('di_encoding'); ?>">
        </div>
        <div class="form-group">
            <label for="ex2" class="sr-only">名称</label>
            <input type="text" placeholder="名称搜索" id="ex2" class="form-control" name="di_name" value="<?php echo input('di_name'); ?>">
        </div>
        <!--<div class="form-group">-->
    ...
    <table class="table table-hover table-bordered table-condensed">
        ...
        <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td width='1'><input type="checkbox" class="my-all-check" name="input[]"></td>
                    <td><?php echo $vo['id']; ?></td>
                    <td><?php echo $vo['di_order']; ?></td>
                    <td><?php echo $vo['di_encoding']; ?></td>
                    <td><?php echo $vo['di_name']; ?></td>
                    <td><?php echo $vo['option_value']; ?></td>
                    <td><?php echo $vo['create_time']; ?></td>
                    <td><?php echo $vo['update_time']; ?></td>
                    <td>
                         <span class="btn-group">
                                <a href="<?php echo url('edit',['id'=>$vo['id']]); ?>" class="btn btn-default btn-outline btn-xs js-window-load" title="编辑"><i class="fa fa-edit fa-fw"></i><span class="hidden-xs">编辑</span></a>
