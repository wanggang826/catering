<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\phpStudy\WWW\demo\public\theme\admin\index\index.html";i:1502172025;s:56:"D:\phpStudy\WWW\demo\public\theme\admin\layout\left.html";i:1502793403;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div id="wrapper">
                ...
                <ul class="nav sidebar-nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span id ="imgs">
                                <?php if($headimg != ''): ?>
                                    <img alt="image" id="headimg" class="img-circle" src="/upload/<?php echo $headimg; ?>" width="70px" height="70px"/>
                                <?php else: ?>
                                    <img alt="image" id="headimg" class="img-circle" src="<?php echo $static_path; ?>img/default1.jpg" width="70px" height="70px"/>
                                <?php endif; ?>
                            </span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <!--</li>-->
                                <li class="divider"></li>
                                <li><a href="<?php echo url('publics/loginOut'); ?>" text="退出登录确认" class=" roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 安全退出</a></li>
                            </ul>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="<?php echo url('Publics/loginOut'); ?>" text="退出登录确认" class="js-del-btn roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
