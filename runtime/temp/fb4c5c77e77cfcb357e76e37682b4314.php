<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"D:\phpStudy\WWW\catering\public\theme\admin\comment\detail.html";i:1512534588;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action="" method='post' enctype=multipart/form-data>
    <!-- 自定义大小 -->
    <div class="form-group">
        <label class="col-sm-2 control-label">评论详情</label>
        <div class="col-sm-8">
            <textarea name="check_desc" id="content" readonly placeholder="备注长度不可大于240个字符" class="form-control"><?php echo $comment['content']; ?></textarea>        </div>
    </div>

    <div class="form-group">
        <label class="col-sm-2 control-label">评论图片</label>
        <div class="col-sm-8 row">
            <?php $__FOR_START_22236__=1;$__FOR_END_22236__=5;for($i=$__FOR_START_22236__;$i < $__FOR_END_22236__;$i+=1){ $img = 'com_img'.($i);if(!empty($comment[$img])): ?>
            <div class="col-xs-3" >
                <img src="__UPLOAD__<?php echo $comment[$img]; ?>">
            </div>
            <?php endif; } ?>
        </div>
    </div>
