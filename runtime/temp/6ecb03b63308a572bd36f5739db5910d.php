<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\phpStudy\WWW\catering\public\theme\admin\goods\discountEdit.html";i:1513072222;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" enctype="multipart/form-data" method='post' action="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="goods_sn" value="<?php echo $goods['goods_sn']; ?>" disabled>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="goods_name" value="<?php echo $goods['goods_name']; ?>" disabled>
        </div>
    </div>


    <div class="form-group">
        <label for="goods_price" class="col-sm-2 control-label"> 原价：</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" name="goods_price" value="<?php echo $goods['goods_price']; ?>" disabled>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="discount" value="<?php echo $goods['discount']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="discount_price" value="<?php echo $goods['discount_price']; ?>" readonly>
        </div>
    </div>
...
<script type="text/javascript">
    $("input[name='discount']").blur(function () {
        ...
        var real_price = (discount * goods_price /10).toFixed(2);
        $("input[name='discount_price']").val(real_price)
    })
</script>
        </div>
    </div>
