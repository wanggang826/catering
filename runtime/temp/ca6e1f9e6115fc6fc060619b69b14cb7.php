<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\phpStudy\WWW\catering\public\theme\admin\member\index.html";i:1512976419;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    <form role="form" action="<?php echo url('index'); ?>" class="panel-body hidden-xs form-inline">
        ...
        <div class="form-group">
            <input type="text" placeholder="手机号" id="user_phone" class="form-control" name="user_phone" value="<?php echo input('user_phone'); ?>">
        </div>
        <div class="form-group">
            <select class=" form-control" name="sex" >
                <option value="">性别</option>
                <option value="female" <?php if(input('sex') == 'female'): ?> selected<?php endif; ?>>女性</option>
                <option value="male" <?php if(input('sex') == 'male'): ?> selected<?php endif; ?>>男性</option>
                <option value="none" <?php if(input('sex') == 'none'): ?> selected<?php endif; ?>>未知</option>
            </select>
        </div>
...
<div class="table-responsive">
    ...
    <thead>
        <tr>
            ...
            <th width="150">昵称</th>
            <th width="150" class="hidden-xs">性别</th>
            <th width="150" class="hidden-xs">手机号码</th>
            <th width="150" class="hidden-xs">积分</th>
            <th width="150" class="hidden-xs">注册时间</th>
            <th width="240">操作</th>
        </tr>
    </thead>
    <tbody>
		...
		<tr>
			...
			<td>
                <?php switch($vo['sex']): case "female": ?>女<?php break; case "male": ?>男<?php break; default: ?>未知
                <?php endswitch; ?>
            </td>
            ...
            <td>
				<span class="btn-group">
                    <a href="<?php echo url('edit',['id'=>$vo['id'],'page'=>$nowpage]); ?>" class="btn btn-default btn-outline btn-xs js-window-load" title="查看"><i class="fa fa-edit fa-fw"></i><span class="hidden-xs">查看</span></a>
                </span>
            </td>
		</tr>
