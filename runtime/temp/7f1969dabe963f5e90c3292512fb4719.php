<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\phpStudy\WWW\catering\public\theme\admin\config\pay_edit.html";i:1513072222;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action="<?php echo U('modify'); ?>" method='post'>
    <!-- 自定义大小 -->
    <?php foreach($config as $key => $value): ?>
    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo $value['name']; ?></label>
        <div class="col-sm-4">
            <input type="text" name="<?php echo $key; ?>" class="form-control" value="<?php echo $value['val']; ?>">
        </div>
        <label><?php echo $value['desc']; ?></label>
    </div>
    <?php endforeach; ?>
    <input type="text" value='<?php echo $id; ?>' name="id" style="visibility: hidden;">
    <div class="form-group">
