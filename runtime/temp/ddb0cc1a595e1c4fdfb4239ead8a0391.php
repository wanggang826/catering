<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\www\alasika\public\theme\admin\printing\model_add.html";i:1503989542;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" id="validate_form" action='<?php echo url('model_add'); ?>' enctype="multipart/form-data">
   <div class="form-group">
        <label for="" class="col-sm-2 control-label">印花机型号</label>
        <div class="col-sm-4">
            <input type="text" name="model_name" class="form-control" id="model_name" placeholder="控制端型号" js-check="model_name">
        </div>
    </div>
    <div class="form-group">
        <label for="" class="col-sm-2 control-label">启用状态</label>
        <div class="col-sm-4">
            <?php echo diction_option($option['status'],1,"radio"); ?>
        </div>
    </div>
    <div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="system_id" js-check="system_id">
            <?php echo diction_option($option['system']); ?>
        </select>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="resolution_id" js-check="resolution_id">
            <?php echo diction_option($option['resolution']); ?>
        </select>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="direction_id" js-check="direction_id">
            <?php echo diction_option($option['direction']); ?>
        </select>
    </div>
</div>
<div class="form-group">
