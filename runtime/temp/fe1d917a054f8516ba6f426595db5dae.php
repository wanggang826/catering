<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\phpStudy\WWW\catering\public\theme\admin\waiting\eatInOrder.html";i:1514873676;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <form role="form" action="<?php echo url('Waiting/eatInOrder'); ?>" class="form-inline panel-body hidden-xs">
        <div class="form-group">
            订单号：<input type="text" placeholder="请输入订单号" id="order_sn" class="form-control" name="order_sn" value="<?php echo input('order_sn'); ?>">
        </div>
        <div class="form-group">
            下单用户：<input type="text" placeholder="请输入用户id" id="member_id" class="form-control" name="member_id" value="<?php echo input('member_id'); ?>">
        </div>
...
<div class="table-responsive">
    <table class="table table-hover table-bordered table-condensed">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('orderDetail',['order_id'=>$vo['order_id'], 'location'=>'eatInOrder']); ?>"><span class="hidden-xs">查看并处理</span></a>
            </td>
        </tr>
