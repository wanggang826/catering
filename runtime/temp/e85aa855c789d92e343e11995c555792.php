<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"D:\www\alasika\public\theme\admin\Partition\add.html";i:1502702054;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action='<?php echo url('add_partition'); ?>' method='post'>
<!-- 自定义大小 -->
<div class="form-group">
    <label for="partition_name" class="col-sm-2 control-label">分区名称</label>
    <div class="col-sm-4">
        <input type="text" name="partition_name" class="form-control" id="partition_name" placeholder="分区名称">
    </div>
</div>
<div class="form-group">
    <label for="manager" class="col-sm-2 control-label">负责人</label>
    <div class="col-sm-4">
        <input type="text" name="manager" class="form-control" id="manager" placeholder="负责人">
    </div>
</div>
<div class="form-group">
    <label for="manager_tel" class="col-sm-2 control-label">联系方式</label>
    <div class="col-sm-4">
        <input type="text" name="manager_tel" class="form-control" id="manager_tel" placeholder="联系方式">
    </div>
</div>
<div class="form-group">
    <label for="agents" class="col-sm-2 control-label">所属机构</label>
    <div class="col-sm-4">
        <?php echo $agents; ?>
    </div>
</div>
