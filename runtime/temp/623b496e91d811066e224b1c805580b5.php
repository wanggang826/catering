<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"D:\www\alasika\public\theme\admin\publish_adv\edit.html";i:1505117619;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<input type="hidden" name="publish_id" value="<?php echo $partition['publish_id']; ?>">
<div class="form-group">
    <label for="serial_number" class="col-sm-2 control-label">编号</label>
    <div class="col-sm-4">
        <input type="text" name="serial_number" class="form-control" id="serial_number" value="<?php echo $partition['serial_number']; ?>">
    </div>
</div>
<div class="form-group">
    <label for="publish_name" class="col-sm-2 control-label">名称</label>
    <div class="col-sm-4">
        <input type="text" name="publish_name" class="form-control" id="publish_name" value="<?php echo $partition['publish_name']; ?>">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" name="take_effect_time" class="form-control i-datestart" id="take_effect_time" value="<?php echo $partition['take_effect_time']; ?>">
    </div>
</div>
<div class="form-group">
    <label for="time" class="col-sm-2 control-label">时长</label>
    <div class="col-sm-4">
        <input type="text" name="time" class="form-control" id="time" value="<?php echo $partition['time']; ?>">
    </div>
</div>
<div class="form-group">
    <label for="matter_number" class="col-sm-2 control-label">素材数量</label>
    <div class="col-sm-4">
        <input type="text" name="matter_number" style="background-color: #ffffff" readonly="readonly" class="form-control" id="matter_number" value="<?php echo $partition['matter_number']; ?>">
    </div>
</div>
<div class="form-group">
    <label for="device_number" class="col-sm-2 control-label">咖啡机数量</label>
    <div class="col-sm-4">
        <input type="text" name="device_number" style="background-color: #ffffff" readonly="readonly" class="form-control" id="device_number" value="<?php echo $partition['device_number']; ?>">
    </div>
</div>
<div class="form-group">
    <label for="remarks" class="col-sm-2 control-label">备注</label>
    <div class="col-sm-4">
        <input type="text" name="remarks" class="form-control" id="remarks" value="<?php echo $partition['remarks']; ?>" >
    </div>
</div>
<input type="hidden" id="advertising_id" name="advertising_id" value="<?php echo $partition['advertising_id']; ?>">
<input type="hidden" id="device_id" name="device_id" value="<?php echo $partition['device_id']; ?>">
<div class="form-group">
