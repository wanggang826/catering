<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\www\alasika\public\theme\admin\device\control_edit.html";i:1504002403;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" id="validate_form" action='<?php echo url('control_edit'); ?>' enctype="multipart/form-data">

   <div class="form-group">
        <label for="" class="col-sm-2 control-label">控制端型号</label>
        <div class="col-sm-4">
            <input name="control_id" type="hidden" value="<?php echo $data['control_id']; ?>">
            <input type="text" name="control_name" class="form-control" id="control_name" value="<?php echo $data['control_name']; ?>" placeholder="控制端型号" js-check="control_name">
        </div>
    </div>
    <div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="system_id" js-check="system_id">
            <?php echo diction_option('system',$data['system_id'])?>
        </select>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="resolution_id" js-check="resolution_id">
            <?php echo diction_option('resolution',$data['resolution_id'])?>
        </select>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="direction_id" js-check="direction_id">
            <?php echo diction_option('direction',$data['direction_id'])?>
        </select>
    </div>
</div>
<div class="form-group">
