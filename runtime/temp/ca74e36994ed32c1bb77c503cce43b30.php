<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\phpStudy\WWW\catering\public\theme\admin\waiting\orderDetail.html";i:1514873676;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <form role="form" action="" class="form-inline panel-body">
        ...
        <div class="form-group">
            <p class="form-control" > 收货人：<?php echo $order['memberAddress']['name']; ?></p>
        </div>
        <div class="form-group">
            <p class="form-control" >  联系电话：<?php echo $order['tel']; ?></p>
        </div>
        <div class="form-group">
            <p class="form-control" style="width: 380px" > 详细地址：<?php echo $order['address']; ?></p>
        </div>
        <div class="form-group">
            <p class="form-control"> 状态：<?php echo $status[$order['status']]; ?></p>
        </div>
...
<a href="<?php echo $url; ?>" class="btn btn-default" js-title="返回列表" js-unique="true">
    &nbsp;返回列表
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<?php if($order['type'] == 0): ?>
<a href="<?php echo url('changeStatus',['table'=>'order', 'pk'=>'order_id', 'id'=>$order['order_id'],'status'=>1, 'location'=>'eatInOrder']); ?>" class="btn btn-default  btn-md js-del-btn " js-title="设置订单完成" text="确定设为订单完成吗？"js-unique="true">
    &nbsp;&nbsp;已完成&nbsp;&nbsp;
</a>
<?php elseif($order['status'] == 0): ?>
<a href="<?php echo url('changeStatus',['table'=>'order', 'pk'=>'order_id', 'id'=>$order['order_id'],'status'=>1, 'location'=>'takeoutOrder']); ?>" class="btn btn-default  btn-md js-del-btn " js-title="设置订单完成" text="确定接单吗？"js-unique="true">
    &nbsp;&nbsp;接单&nbsp;&nbsp;
</a>
<?php else: ?>
<a href="<?php echo url('changeStatus',['table'=>'order', 'pk'=>'order_id', 'id'=>$order['order_id'],'status'=>2, 'location'=>'takeoutOrder']); ?>" class="btn btn-default  btn-md js-del-btn " js-title="设置订单完成" text="确定派送吗？"js-unique="true">
    &nbsp;&nbsp;派送&nbsp;&nbsp;
</a>
<?php endif; ?>
