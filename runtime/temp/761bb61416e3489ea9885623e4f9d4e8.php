<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\www\alasika\public\theme\admin\printing\model_edit.html";i:1503991075;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" id="validate_form" action='<?php echo url('model_edit'); ?>' enctype="multipart/form-data">

   <div class="form-group">
        <label for="" class="col-sm-2 control-label">控制端型号</label>
        <div class="col-sm-4">
            <input name="model_id" type="hidden" value="<?php echo $data['model_id']; ?>">
            <input type="text" name="model_name" class="form-control" id="model_name" value="<?php echo $data['model_name']; ?>" placeholder="控制端型号" js-check="model_name">
        </div>
    </div>
    <div class="form-group">
        <label for="" class="col-sm-2 control-label">启用状态</label>
        <div class="col-sm-4">
            <?php echo diction_option($option['status'],$data['status'],"radio"); ?>
        </div>
    </div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="manufacturer_id" js-check="manufacturer_id">
            ...
            <option value="<?php echo $vo['factor_id']; ?>" <?php if($data['manufacturer_id'] == $vo['factor_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['factor_name']; ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" name="IPC" class="form-control" id="IPC" value="<?php echo $data['IPC']; ?>" placeholder="工控机型号" js-check="IPC">
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="system_id" js-check="system_id">
            <?php echo diction_option($option['system'],$data['system_id']); ?>
        </select>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" name="display_size" class="form-control" id="display_size" value="<?php echo $data['display_size']; ?>" placeholder="显示屏尺寸" js-check="display_size">
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="resolution_id" js-check="resolution_id">
            <?php echo diction_option($option['resolution'],$data['resolution_id']); ?>
        </select>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="direction_id" js-check="direction_id">
            <?php echo diction_option($option['direction'],$data['direction_id']); ?>
        </select>
    </div>
</div>
<div class="form-group">
...
<script type="text/javascript">
     ...
     * 验证
     * */
    function model_name(e){
        var model_name = $(e).val();
        if (model_name == '') {
            return '请填写控制端型号!';
        }
        return true;
    ...
    var file_data=<?php echo $data['show_image']; ?>;
</script>
        </div>
    </div>
</body>
