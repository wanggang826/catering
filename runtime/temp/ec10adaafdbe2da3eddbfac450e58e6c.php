<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\phpStudy\WWW\catering\public\theme\admin\banner\add.html";i:1512555557;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action="<?php echo U('add'); ?>">
    <div class="form-group">
        <label class="col-sm-2 control-label">名称</label>
        <div class="col-sm-4">
            <input type="text" name="name" value="" class="form-control" placeholder="名称">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <label class="i-lab">
                <input type="radio" name="status" value="0" class="mgr mgr-primary  mgr-lg" checked><span>禁用</span>
            </label>
            <label class="i-lab">
                <input type="radio" name="status" value="1" checked class="mgr mgr-primary mgr-lg" ><span>启用</span>
            </label>
        </div>
    </div>
    <div class="form-group">
