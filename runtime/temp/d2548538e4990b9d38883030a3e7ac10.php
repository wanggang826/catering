<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"D:\www\alasika\public\theme\admin\printing\manage.html";i:1504077982;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-footer clearfix ">
        <div class="pull-left btn-group hidden-xs" >
            <a href="<?php echo url('printing_add'); ?>" js-title="新增" class="btn btn-default js-window-load" js-title="新增" js-unique="true" js-width="60%" js-height="80%">
                <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;新增
            </a>
            <a href="<?php echo url('del_printing'); ?>" class="btn btn-outline btn-default js-del-btn del-all" text="删除后将无法恢复，请谨慎操作">
                <i class="fa fa-trash" aria-hidden="true"></i>&nbsp;批量删除
            </a>
            <a href="javascript:export_printing()" class="btn btn-default btn-outline">
        ...
        <div class="pull-right">
            <select class="form-control" name="status">
                ...
                <input type="text" name="query_condition" class="form-control" value="<?php echo input('query_condition'); ?>" placeholder="编号">
...
<div class="table-responsive">
        ...
        <thead>
            <tr>
                ...
                <th width="240">操作</th>
                <th width="150" class="hidden-xs">印花机编号</th>
                <th width="150" class="hidden-xs">机型图片</th>
                <th width="150" class="hidden-xs">印花机型号</th>
                <th width="150" class="hidden-xs">印花机版本号</th>
        ...
        <tr>
            ...
            <td>
                <span class="btn-group">
                    <a href="<?php echo url('printing_edit',array('id'=>$vo['id'])); ?>" class="btn btn-default btn-outline btn-xs js-window-load" title="编辑"><i class="fa fa-edit fa-fw"></i><span class="hidden-xs">编辑</span></a>
                    ...
                    <a href="<?php echo url('del_printing',['id'=>$vo['id']]); ?>" class="btn  btn-danger btn-outline btn-xs js-del-btn" text="删除后将无法恢复,请谨慎操作！"><i class="fa fa-trash-o fa-fw"></i><span class="hidden-xs">删除</span></a>
                </span>
            </td>
            ...
            <td><?php echo $vo['model_version']; ?></td>
