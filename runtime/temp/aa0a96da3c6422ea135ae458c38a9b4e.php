<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"D:\www\alasika\public\theme\admin\adv_matter\add.html";i:1505113779;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action='<?php echo url('add'); ?>'>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="serial_numbe" class="form-control" id="serial_numbe" placeholder="编号">
        </div>
    </div>
    <div class="form-group">
        <label for="ma_name" class="col-sm-2 control-label">名称</label>
        <div class="col-sm-4">
            <input type="text" name="ma_name" class="form-control" id="ma_name" placeholder="名称">
        </div>
    </div>
    <div class="form-group">
        <label for="adv_status" class="col-sm-2 control-label">状态</label>
        <div class="col-sm-4">
            <select   class="form-control"  name="adv_status" id="adv_status">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="type" class="form-control" readonly="readonly" style="background-color: #ffffff" id="type" placeholder="文件类型">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <!--<input id="input-4" name="material[]" type="file"  multiple class="file-loading" data-show-caption="true">-->
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea class="form-control" id="remarks" name="remarks" placeholder="备注"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="" class="col-sm-2 control-label"></label>
