<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\phpStudy\WWW\catering\public\theme\admin\goods\edit.html";i:1512976419;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="gray-bg  animated fadeIn">
    ...
    <form class="form-horizontal js-ajax-form clearfix" enctype="multipart/form-data" method='post' action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="goods_sn" value="<?php echo $goods['goods_sn']; ?>" readonly>
            </div>
        </div>

        <div class="form-group">
            <label for="goods_sn" class="col-sm-2 control-label"> 商品名称：</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="goods_name" value="<?php echo $goods['goods_name']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <select id="cate" class="define_select form-control" name="cate_id">
                    ...
                    <option value="<?php echo $vo['cate_id']; ?>" <?php if($goods['cate_id'] == $vo['cate_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="goods_unit" value="<?php echo $goods['goods_unit']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="goods_price" value="<?php echo $goods['goods_price']; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="desc" id="" cols="49" rows="5"><?php echo $goods['desc']; ?></textarea>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $('#goods_thumb').imgUpload({
            ...
            files:{
                0:"<?php echo defaultImg($goods['goods_thumb']); ?>",
            }
        })
        $('#goods_img').imgUpload({
            // width:150,//预览宽度
            ...
            files:{
                0:'<?php echo defaultImg($goods['goods_img1']); ?>',
                1:'<?php echo defaultImg($goods['goods_img2']); ?>',
                2:'<?php echo defaultImg($goods['goods_img3']); ?>',
                3:'<?php echo defaultImg($goods['goods_img4']); ?>',
                4:'<?php echo defaultImg($goods['goods_img5']); ?>',
            }
        })
    </script>
        </div>
