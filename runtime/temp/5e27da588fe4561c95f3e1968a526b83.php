...
<div class="panel panel-default">
    ...
    <form role="form" action="<?php echo url('Order/orderList', ['type'=>$type]); ?>" class="form-inline panel-body hidden-xs">
...
<div class="table-responsive">
    <table class="table table-hover table-bordered table-condensed">
        ...
        <tr>
            ...
            <td>
                <a href='<?php echo url("orderDetail",["order_id"=>$vo['order_id'], "type"=>"$type"]); ?>' class="btn btn-default  btn-xs"><span class="hidden-xs">查看</span></a>
            </td>
        </tr>
