...
<section id="new">
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><a href="#battery-empty"><i class="fa fa-battery-empty"></i> battery-0 <span class="text-muted">(alias)</span></a></div>
...
<script type="text/javascript">
    $('a').on('click', function(){
        var iconName = $(this).attr('href').trim().substr('1');
        parent.$('#menu_icon').val(iconName);
        parent.layer.msg('<i class="fa fa-check fa-lg"></i>&nbsp;选择成功',{time:800});
