<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\phpStudy\WWW\catering\public\theme\admin\coupon\coupon_add.html";i:1512630810;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\layout.html";i:1502172025;s:62:"D:\phpStudy\WWW\catering\public\theme\admin\layout\static.html";i:1503460468;s:58:"D:\phpStudy\WWW\catering\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" action="<?php echo U('coupon_add'); ?>" method='post'>
<!-- 自定义大小 -->
    ...
    <div class="row" style="margin:50px 0px">
        <div class="col-xs-12">
            ...
            <div class="col-xs-4">
                <input type="text" name="valid_start" class="form-control i-datestart"  id="date2" placeholder="有效期(起)" value="<?php echo input('start_time'); ?>">
            </div>
            <div  class="col-xs-1">
            ...
            <div class="col-xs-4">
                <input type="text" name="valid_end" class="form-control i-dateend" id="date3" placeholder="有效期(末)" value="<?php echo input('end_time'); ?>">
            </div>
        </div>
    </div>
