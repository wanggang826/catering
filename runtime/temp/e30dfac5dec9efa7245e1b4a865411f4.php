<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\www\alasika\public\theme\admin\printing\printing_edit.html";i:1504064164;s:52:"D:\www\alasika\public\theme\admin\layout\layout.html";i:1502172025;s:52:"D:\www\alasika\public\theme\admin\layout\static.html";i:1503460468;s:48:"D:\www\alasika\public\theme\admin\layout\js.html";i:1503460468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal js-ajax-form clearfix" id="validate_form" action="<?php echo url('printing_edit'); ?>" enctype="multipart/form-data">
   <div class="form-group">
        <label for="" class="col-sm-2 control-label">印花机编号</label>
        <div class="col-sm-4">
            <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
            <input type="text" name="printing_code" class="form-control" id="printing_code" placeholder="印花机编号" value="<?php echo $data['printing_code']; ?>" js-check="printing_code">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="col-sm-4">
        <select   class="form-control"  name="model_id" js-check="model_id">
            ...
            <option value="<?php echo $vo['model_id']; ?>" <?php if($data['model_id'] == $vo['model_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['model_name']; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">印花机版本</label>
    <div class="col-sm-4">
        <input type="text" name="model_version" class="form-control" id="model_version" placeholder="印花机版本" value="<?php echo $data['model_version']; ?>" js-check="model_version">
    </div>
</div>
<div class="form-group">
